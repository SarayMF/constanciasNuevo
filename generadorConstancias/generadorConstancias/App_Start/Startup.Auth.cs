...
using Owin;
using generadorConstancias.Models;
...
namespace generadorConstancias
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            {
                ClientId = "618558720519-i24g970gjmbef1350tn7gf2hn4p2vagm.apps.googleusercontent.com",
                ClientSecret = "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"
            });
        }
    }
}